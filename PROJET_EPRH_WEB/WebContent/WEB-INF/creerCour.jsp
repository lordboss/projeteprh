			...
			<div id="header_container">
				<div id="header">
					<div id="logo">
						...
						<div style="color:#FF2402;" class="slogan"><font color="blue"><center>ENREGISTREMENT D'UN NOUVEAU COURS</center></font></div>
					</div>		
				     ...
				     <div id="maincontent">						
					     <div class="foxcontainer" style="width:100% !important;"><h2><center>Entrez les informations concernant le cours à enregistrer</center></h2>
                            <center></center> <form    method="post" action="eprh">
                                  ...
                                  <input class="foxtext" type="text" value="" title="Intitule du cours" style="width:150px !important;" name="intitule"  required="true"/></div>
                                  
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Code du cours: </label>
                                  <input class="foxtext" type="text" value="" title="Code du cours" style="width:150px !important;" name="codec"  required="true"/></div>
                                  ...
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Enseignant: </label>
                                  ...
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Niveau: </label>
                                  <select name="niveau">
                                  ...
                                  <input  type="submit"  value="Creer" name="connection">                                                               
