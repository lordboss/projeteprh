				...
				<div id="ce_contenu" class="col1">
					<article class="article">
						...
						<section class="intro">	<p>
						 <h2><center>Entrez le nom du fichier à conssulter</center></h2>
                            <center><div><table width="65%" border=0> <form    method="post" action="Dowload">
                         
                                                                    
                                  
                                  <tr> <td align="left"><label ><font color="black">Nom du fichier: </font></label></td><td align="left">
                                  <select name="fichierRequis">
                                  <c:forEach items="${listePv}" var="ens">
