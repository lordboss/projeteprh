				...
				<div id="ce_contenu" class="col1">
					<article class="article">
						...
						<section class="intro">	<p>
						 <h2><center>Entrez les informations concernant le PV à enregistrer</center></h2>
                            <center><div><table width="65%" border=0> 
                            <form    method="post" name="f1" action="pv" >
                         
                                                                    
                                  <tr> <td align="left"><label ><font color="black">Intitulé de la réunion: </font></label></td><td align="left">
                                  <input type="text" value="" title="Intitule de la réunion"  name="intitule"  required="true"/>
                                  </td></tr><tr><td><font color="white">.</font></td><td><font color="white">.</font></td></tr>
                                  
                                  <tr> <td align="left"><label ><font color="black">Date de la réunion: </font></label></td><td align="left">
                                  <select name="annee">
                                      <option value="0">Année
                                      <c:forEach var="i" begin="1975" end="2100" step="1">
                                  ...
                                  <tr> <td align="left"><label ><font color="black">Semestre: </font></label></td><td align="left">
                                  <select name="semestre">
                                      <option value="0">semestre
                                  ...
                                  <tr> <td align="left"><label ><font color="black">Fichier: </font></label></td><td align="left">
                                  <input type="file" value="" title="fichier"  name="fichier"  required="true" />
                                  
                                  </td></tr><tr><td><font color="white">.</font></td><td><font color="white" >.</font></td></tr>
                                  
                                  <tr> <td align="left"><label ><font color="black">Chemin du Fichier: </font></label></td><td align="left">
                                  <input type="text" value="" title="chemin du fichier"  name="fichie"  required="true" />
