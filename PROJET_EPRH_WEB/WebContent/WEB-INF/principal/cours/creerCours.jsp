				...
				<div id="ce_contenu" class="col1">
					<article class="article">
						...
						<section class="intro">	<p>
						 <h2><center>Entrez les informations concernant le cours à enregistrer</center></h2>
                            <center><div><table width="65%" border=0> <form    method="post" action="cours">
                                  ...
                                  <input type="text" value="" title="Intitule du cours"  name="intitule"  required="true"/>
                                  ...
                                  <input type="text" value="" title="Code du cours"  name="codec"  required="true"/>
                                  </td></tr><tr><td><font color="white">.</font></td><td><font color="white">.</font></td></tr>
                                  ...
                                  <tr> <td align="left"><label ><font color="black">Niveau: </font></label></td><td align="left">
                                  <select name="niveau">
