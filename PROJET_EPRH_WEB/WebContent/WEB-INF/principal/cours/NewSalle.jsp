				...
				<div id="ce_contenu" class="col1">
					<article class="article">
						...
						<section class="intro">	<p>
						 <h2><center>Entrez les informations concernant la salle de cours à créer</center></h2>
                            <center><div><table width="65%" border=0> <form    method="post" action="cours">
                         
                                                                    
                                  <tr> <td align="left"><label ><font color="black">Nom de la salle: </font></label></td><td align="left">
                                  <input type="text" value="" title="Nom de la salle"  name="name"  required="true"/>
                                  </td></tr><tr><td><font color="white">.</font></td><td><font color="white">.</font></td></tr>
                                  <tr> <td align="left"><label ><font color="black">Code de la salle: </font></label></td><td align="left">
                                  <input type="text" value="" title="Code de la salle"  name="code"  required="true"/>
                                  </td></tr><tr><td><font color="white">.</font></td><td><font color="white">.</font></td></tr>
                                  <tr> <td align="right">
