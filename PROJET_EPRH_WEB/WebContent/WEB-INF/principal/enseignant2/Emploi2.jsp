			...
			<div id="ventre" class="clearfix">
				<div id="ce_contenu" class="col1">
					<article class="article">
						...
						<section class="intro">
						<div ><h2><center>Emploi du Temps de Mr/Mme: ${enseignant }</center></h2>
                            <table border=1 width="90%">
                                <thead bgcolor="cyan">
                                    <td width="35%" align="center">Intitule du cours</td>
                                     <td width="18%" align="center">Salle</td>
                                    <td width="17%" align="center">Code du cours</td>
                                    <td width="12%" align="center">Niveau d'étude</td>
                                     <td width="20%" align="center">Horaire</td></thead> 
