				...
				<div id="ce_contenu" class="col1">
					<article class="article">
						...
						<section class="intro">	<p>
						 <h2><center>Veuillez clicquer sur "lister" pour afficher les commandes pass&eacute;es </center></h2>
                            <center><div><table width="65%" border=0> <form    method="post" action="materiel">
                         
                                                                    
                                  <tr> <td align="left"><label ><font color="black"> </font></label></td><td align="left">
                                  ...
                                  <tr> <td align="rigth">
                                  <td></td><input  type="submit"  value="Listerc" name="connection">
                                   </td><td align="left">                                                               
                                 </form></table></div><br>
                             ${resultat1 }
                             </center>
