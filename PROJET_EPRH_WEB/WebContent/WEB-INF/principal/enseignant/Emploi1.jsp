			...
			<div id="ventre" class="clearfix">
				<div id="ce_contenu" class="col1">
					<article class="article">
						...
						<div >						
					     <div ><h2><center>Entrez les informations concernant l'enseignant<br>dont vous voulez vérifier l'emploi du temps</center></h2>
                            <center><table width="65%" border=0> <form    method="post" action="enseignant">
                                <div>
                                <tr> <td align="left"><label >Identifiant de l'enseignant: </label></td><td align="left">
                                    <input value="" title="identifiant" name="enseignant"  required="true"/></div>                                     
                             ...
                             </form></table></div><br></center>${erreur}
                         </div>						
