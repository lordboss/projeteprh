			...
			<div id="ventre" class="clearfix">
				<div id="ce_contenu" class="col1">
					<article class="article">
						...
						<section class="intro">
							<p>
							<h2><center>Sélectionnez le login de l'enseignant</center></h2>
                            <center><div><table width="65%" border=0> <form    method="post" action="enseignant">
                         
								<tr>
									<td align="left"><label><font color="black">Enseignant:
										</font></label></td>
									<td align="left"><select name="enseignant">
								...
								<tr>
									<td align="right"><input type="submit" value="Dossier"
										name="connection"></td>
				...
				<aside class="sideBar">
					...
					<div class="bloc defaut">
						...
						<div id="ajaxCV">
							<div class="tx-sharecms-pi1">
							<a href="enseignant?action=1"> Enregistrer un enseignant</a>
						</div>
							<div class="tx-sharecms-pi1">
							<a href="enseignant?action=2"> Modifier un enseignant</a>
						</div>
							<div class="tx-sharecms-pi1">
							<a href="enseignant?action=3"> Consulter l'emploi du temps d'un enseignant</a>
						</div>
							<div class="tx-sharecms-pi1">
							<a href="enseignant?action=4"> Consulter la fiche des enseignants</a>
						</div>
							<div class="tx-sharecms-pi1">
							<a href="enseignant?action=5"> Consulter la fiche d'un enseignant</a>
						</div>
						<br> <br> <br> <br> <br> <br>
							<br> <br> <br> <br> 
