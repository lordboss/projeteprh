				...
				<div id="ce_contenu" class="col1">
					<article class="article">
						...
						<center>	     						
					     ...
					     <div ><h2><center>Entrez les informations du personnel à modifier</center></h2>
                            <center></center>
                            <div><table width="65%" border=0> <form    method="post" action="enseignant">
                                  <div >
                                  <tr> <td align="left"><label >Login: </label></td><td align="left">
                                  <input type="text" value="${login }" title="Login" name="login"  required="true"/></div>
                                  </td></tr><tr><td><font color="white">.</font></td><td><font color="white">.</font></td></tr>
                                   <tr> <td align="left"><label >Nouveau grade: </label></td><td align="left">
                                  <select name="grade">
                                  ...
                                  <tr> <td align="left"><label >Diplôme de plus élevé: </label></td><td align="left">
                                  <select name="diplome">
                             ...
                             <font color="red"> ${resultat2 }</font></center>
