			...
			<div id="header_container">
				<div id="header">
				 ...
				 <div id="content_outleft">
				     <div id="maincontent">						
					     <div class="foxcontainer" style="width:100% !important;"><h2><center>Emploi du Temps de Mr/Mme: ${enseignant }</center></h2>
                            <table border=1 width="80%">
                                <thead bgcolor="cyan"><td width="50%">Intitule du cours</td>
                                    <td width="10%">Code du cours</td>
                                    <td width="10%">Niveau d'étude</td>
                                     <td width="30%">Horaire</td></thead> 
