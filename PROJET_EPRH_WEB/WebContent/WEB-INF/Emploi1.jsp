			...
			<div id="header_container">
				<div id="header">
					<div id="logo">
						...
						<div style="color:#FF2402;" class="slogan"><font color="blue"><center>INFORMATION SUR LE PERSONNEL</center></font></div>
					</div>		
				 ...
				 <div id="content_outleft">
				     <div id="maincontent">						
					     <div class="foxcontainer" style="width:100% !important;"><h2><center>Entrez les informations concernant l'enseignant<br>dont vous voulez vérifier l'emploi du temps</center></h2>
                            <center></center> <form    method="post" action="eprh">
                                                                                         
                                   
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Identifiant de l'enseignant: </label>
                                    <input class="foxtext" type="text" value="" title="identifiant" style="width:150px !important;" name="enseignant"  required="true"/></div>                                     
