			...
			<div id="header_container">
				<div id="header">
					<div id="logo">
						...
						<div style="color:#FF2402;" class="slogan"><font color="blue"><center>ENREGISTREMENT D'UN PERSONNEL</center></font></div>
					</div>		
				 ...
				 <div id="content_outleft">
				     <div id="maincontent">						
					     <div class="foxcontainer" style="width:100% !important;"><h2><center>Entrez les informations du personnel à enregistrer</center></h2>
                            <center></center> <form    method="post" action="eprh">
                         
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Nom: </label>
                                  <input class="foxtext" type="text" value="" title="Nom et Prénom" style="width:150px !important;" name="nome"  required="true"/></div>
                                  
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Login: </label>
                                  <input class="foxtext" type="text" value="" title="Login" style="width:150px !important;" name="login"  required="true"/></div>
                                  
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Grade: </label>
                                  <select name="grade">
                                  ...
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Diplôme de plus élevé: </label>
                                  <select name="diplome">
                                  ...
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Date de recrutement: </label>
                                  <select name="jour">
                                  ...
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Password: </label>
                                  <input class="foxtext" type="password" value="" title="Password" style="width:150px !important;" name="password" required="true"/></div>
                                  
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Password: </label>
                                  <input class="foxtext" type="password" value="" title="Password" style="width:150px !important;" name="pass" required="true"/></div>
                                  ...
                                  <input  type="submit"  value="Enregistrer" name="connection">                                                               
