			...
			<div id="header_container">
				<div id="header">
					<div id="logo">
						...
						<div style="color:#FF2402;" class="slogan"><font color="blue"><center>INFORMATION SUR LES ENSEIGNANTS DU DEPARTEMENT</center></font></div>
					</div>		
				 ...
				 <div id="content_outleft">
					     ...
					     <div class="foxcontainer" style="width:100% !important;"><h2><center>DOSSIER DES ENSEIGNANTS</center></h2>
					     <c:forEach items="${liste }" var="liste">
					         <div >
					             <c:forTokens var="sous" items="${liste}" delims=";,+">
                                            <br><label >${sous }</label><br>                          
                                 </c:forTokens>
                             </div><br><br><br>
					     </c:forEach>
