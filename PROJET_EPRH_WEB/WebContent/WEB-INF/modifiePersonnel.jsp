			...
			<div id="header_container">
				<div id="header">
					<div id="logo">
						...
						<div style="color:#FF2402;" class="slogan"><font color="blue"><center>MODIFICATION D'UN PERSONNEL</center></font></div>
					</div>		
				     ...
				     <div id="maincontent">						
					     <div class="foxcontainer" style="width:100% !important;"><h2><center>Entrez les informations du personnel à enregistrer</center></h2>
                            <center></center> <form    method="post" action="eprh">
                                  ...
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Nouveau grade: </label>
                                  <select name="grade">
                                  ...
                                  <div style="clear:both;"><label style="float:left;width:220px !important;">Nouveau password: </label>
